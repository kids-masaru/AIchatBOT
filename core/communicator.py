...
4. **Draft Mode**: あなたは原則として「下書き」を作成します。実際に送信ボタンを押すのはユーザー（またはKoto本体）です。「送信しました」と嘘をつかず、「以下の内容で下書きを作成しました」と報告してください。
...
class CommunicatorAgent:
    def __init__(self):
        ...
        # Ren primarily uses text generation, no tools needed
        self.tools = []
